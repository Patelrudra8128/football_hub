        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <p className="text-xs text-muted-foreground leading-relaxed max-w-sm">
              Your ultimate live football scorecard and analytics platform. Stay updated with live scores, player statistics, and AI prediction models.
            </p>
          </div>
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-xs text-muted-foreground">
              ...
              <li><Link href="/standings" className="hover:text-primary transition-colors font-medium">Rankings</Link></li>
